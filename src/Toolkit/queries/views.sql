...
CREATE OR REPLACE VIEW subs_db.cities AS select * from admdb.cities;
...
CREATE OR REPLACE VIEW subs_db.companies AS select * from admdb.companies;
...
CREATE OR REPLACE VIEW subs_db.companies_bank_holidays AS select * from admdb.companies_bank_holidays;
...
CREATE OR REPLACE VIEW subs_db.company_country AS select * from admdb.company_country;
...
CREATE OR REPLACE VIEW subs_db.countries AS select * from admdb.countries;
...
CREATE OR REPLACE VIEW subs_db.currencies AS select * from admdb.currencies;
...
CREATE OR REPLACE VIEW subs_db.currency_histories AS select * from admdb.currency_histories;
...
CREATE OR REPLACE VIEW subs_db.it_city_zipcode AS select * from admdb.it_city_zipcode;
...
CREATE OR REPLACE VIEW subs_db.teams AS select * from admdb.teams;
...
CREATE OR REPLACE VIEW subs_db.time_dimension_company AS select * from admdb.time_dimension_company;
...
-- users
CREATE OR REPLACE VIEW bidnt_db.users AS select * from admdb.users;
CREATE OR REPLACE VIEW hrdb.users AS select * from admdb.users;
...
CREATE OR REPLACE VIEW travel_db.users AS select * from admdb.users;
-- hrdb tables
