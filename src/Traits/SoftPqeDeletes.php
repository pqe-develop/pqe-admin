...
trait SoftPqeDeletes {
     ...
     * @return void
     */
    public static function bootSoftPqeDeletes() {
        static::addGlobalScope(new SoftPqeDeletingScope());
    }
     ...
     * @return void
     */
    public function initializeSoftPqeDeletes() {
        if (!isset($this->casts[$this->getPqeDeletedColumn()])) {
            $this->casts[$this->getPqeDeletedColumn()] = 'integer';
        }
    }
    ...
    protected function performDeleteOnModel() {
        if ($this->forceDeleting) {
            return tap($this->setKeysForSaveQuery($this->newModelQuery())->forceDelete(),
                    function () {
                        $this->exists = false;
                    });
        }
    ...
    protected function runSoftDelete() {
        ...
        $this->{$this->getPqeDeletedColumn()} = $timeDelete;
...
//         }
    ...
    public function restore() {
        ...
        $this->{$this->getPqeDeletedColumn()} = 0;
    ...
    public function trashed() {
        return $this->{$this->getPqeDeletedColumn()} > 0;
    }
     ...
     * @return string
     */
    public function getPqeDeletedColumn() {
     ...
     * @return string
     */
    public function getQualifiedPqeDeletedColumn() {
        return $this->qualifyColumn($this->getPqeDeletedColumn());
    }
}
