    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-currencyCompanies">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('pqeAdmin::cruds.company.fields.suite') }}
                            </th>
                            <th>
...
@endcan
  ...
  let table = $('.datatable-currencyCompanies:not(.ajaxTable)').DataTable({ buttons: dtButtons })
