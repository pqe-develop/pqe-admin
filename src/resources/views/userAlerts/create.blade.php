...
<div class="card">
    <div class="card-header">
        {{ trans('pqeAdmin::global.create') }} {{ trans('pqeAdmin::cruds.userAlert.title_singular') }}
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("user-alerts.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="required" for="alert_text">{{ trans('pqeAdmin::cruds.userAlert.fields.alert_text') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('pqeAdmin::cruds.userAlert.fields.alert_text_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="alert_link">{{ trans('pqeAdmin::cruds.userAlert.fields.alert_link') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('pqeAdmin::cruds.userAlert.fields.alert_link_helper') }}</span>
            </div>
            <div class="form-group">
                <label for="users">{{ trans('pqeAdmin::cruds.userAlert.fields.user') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('pqeAdmin::cruds.userAlert.fields.user_helper') }}</span>
            </div>
            <div class="form-group">
